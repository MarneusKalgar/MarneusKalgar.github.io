            ...
            <article className="article">
                <div className="wrapper">
                    ...
                    <div className="subsection">
                        ...
                        <p>Представители всех уголков Украины - близких и далеких - приехали в эпицентр текущих событий HVAC индустрии. Иностранные гости с нескольких стран Европы, Турции, Китая также присутствовали на Aqua-Therm сегодня. Что касается нас, то мы без всяких сомнений удовлетворены прошедшим днем. Еще больше посетителей с интересом рассмотрели поближе наши образцы, выставленные на стенде, задали интересующие вопросы, получили подробные консультации о наиболее важной для них продукции, а также нашли ближайший к ним филиал «Сантехкомплект» (у нас ведь их 6, не забывайте).</p>
